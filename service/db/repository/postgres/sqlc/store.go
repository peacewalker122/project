...
func (q *SQLStore) UpdateFollowing(
	...
	Toacc, err = q.UpdateAccountFollower(ctx, UpdateAccountFollowerParams{Num: num, ID: toAccount})
	if err != nil {
		return
	}
	Fromacc, err = q.UpdateAccountFollowing(ctx, UpdateAccountFollowingParams{Num: num, ID: fromAccount})
	if err != nil {
		return
	}
	return
