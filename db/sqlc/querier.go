...
type Querier interface {
	...
	CreateLike_feature(ctx context.Context, arg CreateLike_featureParams) (bool, error)
	...
	CreateRetweet_feature(ctx context.Context, arg CreateRetweet_featureParams) (bool, error)
	...
	GetCommentInfo(ctx context.Context, arg GetCommentInfoParams) (CommentFeature, error)
	GetEntries(ctx context.Context, entriesID int64) (Entry, error)
	GetEntriesFull(ctx context.Context, arg GetEntriesFullParams) (Entry, error)
	...
	UpdateLike(ctx context.Context, arg UpdateLikeParams) (bool, error)
