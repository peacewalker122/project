...
const (
	// Label holds the string label denoting the accountnotif type in the database.
	Label = "account_notif"
	...
	// Table holds the table name of the accountnotif in the database.
	Table = "account_notifs"
)

// Columns holds all SQL columns for accountnotif fields.
var Columns = []string{
	FieldID,
	FieldAccountID,
	FieldNotifType,
